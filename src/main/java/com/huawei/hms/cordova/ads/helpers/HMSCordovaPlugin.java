...
public class HMSCordovaPlugin extends CordovaPlugin {
    ...
    private void isInit(CallbackContext cb) throws JSONException{
        Log.d(TAG, "Is init function ran.");
        JSONObject object = new JSONObject();
        object.put("isInit", _init);
        cb.success(object);
    }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if ("init".equals(action)) {
            ...
            return true;
        } else if("isInit".equals(action)){
            isInit(callbackContext);
            return true;
        } else {
